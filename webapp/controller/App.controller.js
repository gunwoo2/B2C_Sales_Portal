sap.ui.define([
	...
	return BaseController.extend("sync.ea.company1.controller.App", {
		...
		onItemSelect: function(oEvent) {
			...
			if (sKey === "plant") {
				// 직영점 선택 시 해당 경로로 이동.
				window.location.href = "https://edu.bgis.co.kr:8443/sap/bc/ui2/flp#synceafindstore-display";
				return;
			}


			if (sKey === "Important Links was pressed") {
				// 직영점 선택 시 해당 경로로 이동.
			...
			if (sKey === "order") {
				// 주문 정보 조회 선택 시 해당 경로로 이동.
				window.location.href = "https://edu.bgis.co.kr:8443/sap/bc/ui2/flp#synceaorderlogin-display";
				return;
			}
		
			// 
			if (sKey === "home" || sKey === "masterSettings" || sKey === "company" || sKey === "Hello") {
				// 
