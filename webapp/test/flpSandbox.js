		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "한국타이어",
									"targetURL": "#synceacompany1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceacompany1-display": {
								"semanticObject": "synceacompany1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.company1",
									"url": sap.ui.require.toUrl("sync/ea/company1")
								}
							}
						}
					}
